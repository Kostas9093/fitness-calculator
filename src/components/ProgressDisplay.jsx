...
const ProgressDisplay = ({ progress }) => {
  ...
  return (
    <div className="new">
      ...
      {muscleKilosDiff > 0 ?  `Carefull... :` : ` Congratulations!!!!`}</h3>
      <h4>{muscleKilosDiff > 0 ? ` You gained ${fatKilosDiff} kg of fat` : ` You lost ${Math.abs(fatKilosDiff)} kg of fat`}</h4>
      ...
      <h4>{muscleKilosDiff > 0 ? ` You gained ${muscleKilosDiff} kg of muscles mass` : ` You lost ${Math.abs(muscleKilosDiff)} kg of muscles mass`}</h4>
    </div>
  );
};
